...
public class PrescriptionContent {
    ...
    private static void addItem(PrescriptionItem item) {
        ITEMS.add(0, item);
    }
...
//        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String dateString = fileNameNoExt;//format.format(new Date(Long.parseLong(fileNameNoExt)));
        return dateString;
    }
     ...
     */
    public static final List<PrescriptionItem> ITEMS = new ArrayList<PrescriptionItem>();

    /**
     * A map of sample (dummy) items, by ID.
     */
    public static final Map<String, PrescriptionItem> ITEM_MAP = new HashMap<String, PrescriptionItem>();
